# Martian Proxy [![Build Status](https://travis-ci.org/Impact-I/martian.svg?branch=master)](https://travis-ci.org/Impact-I/martian)
...
Martian Proxy can be installed using `go install`
    ...
    go get github.com/Impact-I/martian/ && \
    go install github.com/Impact-I/martian/cmd/proxy
...
modifier](https://github.com/Impact-I/martian/wiki/Modifier-Reference#logging) is
...
* `[package.Type]`: The package.Type of the modifier that you want to use. In
  ...
  refer to the [modifier reference](https://github.com/Impact-I/martian/wiki/Modifier-Reference)).
...
[`martian.go`](https://github.com/Impact-I/martian/blob/master/martian.go)).
...
https://groups.Impact-I.com/forum/#!forum/martianproxy-users.

For security related issues please send a detailed report to our private core
group at martianproxy-core@Impact-Igroups.com.
